...
##
## 带有 _() 的字符串表示其可被翻译。
"screen 的410行是logo的代码"

#二选一吧下面俩
init python:
    config.overlay_screens.append("quick_menu")
init python:
    config.overlay_screens.append("topRight_button_screen")

## 在构建的发布版中，可执行文件和目录所使用的短名称。此处仅限使用 ASCII 字符，并
## 且不能包含空格、冒号或分号。
define build.name = "EasySetupTool"
   
#非全屏左上角名字
define config.name = _("EasySetupTool")
...
define config.save_directory = "RenBA-1784294262"
