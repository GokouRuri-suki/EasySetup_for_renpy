...
## 游戏内文本使用的字体。
define gui.text_font = "fonts/SourceHanSansSC-Bold.otf"

## 角色名称使用的字体。
define gui.name_text_font = "fonts/SourceHanSansSC-Bold.otf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "fonts/SourceHanSansSC-Regular.otf"
...
##
## 游戏内菜单使用的选项按钮。
define gui.choice_button_text_yalign = 0.5#确保居中

define gui.choice_button_width = 1300#我猜的这个比例 看着像
...
define gui.choice_button_text_idle_color = '#2f4f55'
define gui.choice_button_text_hover_color = '#2f4f55'
define gui.choice_button_text_insensitive_color = '#4a43437f'
